        ...
        <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          <div className="flex flex-col justify-center gap-6">
            ...
            <p className="text-base leading-relaxed" style={{ color: textSecondary }}>
              I'm a Senior Software Engineer with five years of experience building consumer-facing products end-to-end. I care about the full picture — system architecture, product thinking, and interface craft — and I work best when those concerns are treated as one.
            </p>
            <p className="text-base leading-relaxed" style={{ color: textSecondary }}>
